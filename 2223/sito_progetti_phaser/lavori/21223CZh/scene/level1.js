...
class primoLivello extends Common{
    ...
    create(){
        ...
        this.enemies = this.createEnemies({context: this, enemies: [
            ["hyena", 253, 393, 256, 550],
            ["mummy", 712, 265, 712, 980],
            ["scorpio", 305, 105, 305, 385],
            ["deceased", 1095, 137, 1095, 1410],
            ["snake", 1225, 361, 1225, 1495]
        ]});
        ...
        this.physics.add.overlap(this.player, enemyArr, (player, enemy) => {
            ...
            if(enemy.scene != undefined){
                ...
                if(this.f){
                    eventsCenter.emit("updateHP", -enemy.attackValue, this.level);
                    this.f = false;
                }
