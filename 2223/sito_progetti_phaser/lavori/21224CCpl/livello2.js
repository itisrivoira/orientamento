class livello2 extends Phaser.Scene{
    ...
    create(){
        ...
        this.livello2=this.add.text(300,310,"LEVEL 2",{font: "45px Arial", fill:"orange"})
        ...
        this.physics.add.overlap(this.bomba2, [this.gruppo1, this.gruppo2, this.gruppo3])
        ...
        this.physics.add.collider(this.bomba2, [this.gruppo1, this.gruppo2, this.gruppo3, this.gruppo3],(first,second)=>{
            second.destroy()
            this.punteggio+=10
            this.text.setText("Score: "+this.data.get("score")+String(this.punteggio))
            console.log(this.punteggio)
