...
function create() {
    ...
    scoreText = scene.add.text(16, 16, "Punteggio: " + score, { fontSize: '20px', fill: '#FFF' })
    livesText = scene.add.text(696, 16, "Vite: " + lives, { fontSize: '20px', fill: '#FFF' })
    startText = scene.add.text(400, 300, "Clicca per iniziare\nAbbatti tutte le navigelle nemiche per vincere!", { fontSize: '20px', fill: '#FFF' }).setOrigin(0.5)
