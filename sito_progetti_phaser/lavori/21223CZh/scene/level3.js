...
class terzoLivello extends Common{
    ...
    create(){
        ...
        this.enemies = this.createEnemies({context: this, enemies: [
            ["hyena", 233, 617, 233, 463],
        ["mummy", 640, 521, 640, 1130],
        ["scorpio", 1258, 361, 1258, 1568],
        ["deceased", 915,201, 915,1222],
        ["snake", 266, 297, 266, 549],
        ["mummy", 1450, 553, 1450, 1723]
        ]});
