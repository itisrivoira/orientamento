...
class quartoLivello extends Common{
    ...
    create(){
        ...
        this.enemies = this.createEnemies({context: this, enemies: [
            ["hyena", 253, 745, 256, 550],
            ["mummy", 1500, 745, 1500, 1800],
            ["scorpio", 890, 617, 890, 1136],
            ["deceased", 1136,617, 1136,1350],
            ["snake", 1256, 457, 1256, 1633],
            ["hyena", 903, 265, 903, 1350],
            ["deceased", 130,201, 130,373],
            ["scorpio", 373, 201, 373, 575]
        ]});
